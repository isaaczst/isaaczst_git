...
-
  > 我首先根据 32 中讨论的概念讲述偶成论的框架·确定性动力学系统可以在两个细节层次上进行描述：根据动力学规则对状态的细粒描述·和对状态类型的粗粒统计解释·不是所有的动力学系统都具有动力学规则很多系统·特别是那些经历随机过程的系统·只有统计描述·多数科学家承认·系统的一些详细信息会由于统计描述而丢失·尽管这些信息对确定性动力学来说没有必要·但我们只是不知道丢失了什么信息。相反·偶成论宣称·统计描述是完全的、基本的·因为它们将客观偶然性的运作解释为系统的倾向、超势或天命性质·在统计分布下不存在什么确定性的动力学·我们碰巧具有的动力学规则是肤浅的、粗的描述·或者是帮助我们从主观上组织分布的理论工具·把这些思想归纳到决定论基于的同一个形而上学层次偶成论认为因果实系不是明确的·而是概然性的·
- 统计是一种事后的“预估”，它是对行为现象的“统计”，而很可能根本与行为现象的本质（动力）没有关系。期待一些数学模型通过概率和统计的介入，而构建了“认知模型”（比如大量的计算主义的认知架构），在我看来仍然忽略了这些模型根本不能解释“认知”的所谓本质，而只能停留在对行为的”分析“的性质。
- 基于这样的通路，具身认知强调行为在环境中的耦合，才是认知的本质，似乎还颇为合理
- 为什么只有将现象还原成“元素”（大脑——神经元）以及依赖于这些元素的“计算”，而不是将现象还原为元素的关系（行为——环境）才是更本质的思维通路呢？
- 假如在物理学中，我们已经清楚的明白，所谓的“裸元素”是根本不存在的，而元素在各自的“场域“中才能定义，我们有是出于什么理由，完全拒绝”延展认知“将这种洞见放进对人类认知的研究中呢？
- 延展认知否定了大脑的作用吗？当延展认知认为大脑(肉）必须耦合入环境才能显现”认知“，并强调这种现象对于我们人类的认知能力来说，很可能是根本性的“界限”，因此论断“行为”是认知的本质，这样的结论的时候，在什么意义上否定了大脑的“价值”？
- 综上所述，我的理解时，行为——具身认知作为一个认知理论，是一个范式性的挑战，对于传统的计算主义的认知理论来说，它所有的原罪就在于，它并不愿意遵守旧方法的“界限”。
- 那么，我们如何理解“行为”呢？进一步说，为什么“行为”能够定义认知呢？仅仅是因为计算主义不成功，必须通过“行为-反馈”来修正吗？如果是这样，延展认知就只是个“过渡理论”，是一个另科学探索精神绝不会满意的答案。
- 我的理解是，事情仍然没有那么简单，行为并不是一个“权宜之计”，它很可能有深刻的方法论上的探讨价值，而这个问题，就延伸到题主的另一个提问了：那就是作为“隐喻”的行为是否才是行为的根本价值？
- 这就是另外一个问题喽~
-
- 作者：云卷天舒
