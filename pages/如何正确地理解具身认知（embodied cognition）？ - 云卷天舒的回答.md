...
-
  > 我首先根据 32 中讨论的概念讲述偶成论的框架·确定性动力学系统可以在两个细节层次上进行描述：根据动力学规则对状态的细粒描述·和
  对状态类型的粗粒统计解释·不是所有的动力学系统都具有动力学规则
  很多系统·特别是那些经历随机过程的系统·只有统计描述·多数科学家承
  认·系统的一些详细信息会由于统计描述而丢失·尽管这些信息对确定性动
  力学来说没有必要·但我们只是不知道丢失了什么信息。相反·偶成论宣
  称·统计描述是完全的、基本的·因为它们将客观偶然性的运作解释为系统
  的倾向、超势或天命性质·在统计分布下不存在什么确定性的动力学·我
  们碰巧具有的动力学规则是肤浅的、粗的描述·或者是帮助我们从主观上组
  织分布的理论工具·把这些思想归纳到决定论基于的同元个形而上学层
  公
  在大街
  知子@云
