...
-
  > 我首先根据 32 中讨论的概念讲述偶成论的框架·确定性动力学系统可以在两个细节层次上进行描述：根据动力学规则对状态的细粒描述·和对状态类型的粗粒统计解释·不是所有的动力学系统都具有动力学规则很多系统·特别是那些经历随机过程的系统·只有统计描述·多数科学家承认·系统的一些详细信息会由于统计描述而丢失·尽管这些信息对确定性动力学来说没有必要·但我们只是不知道丢失了什么信息。相反·偶成论宣
