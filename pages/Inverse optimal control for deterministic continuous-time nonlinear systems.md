...
- The max-margin inverse reinforcement learning method of Abbeel and Ng [1].
	...
	- This method works by trying to learn a cost function that, when minimized, yields a trajectory with similarfeatures as the expert. This method recently contributed
