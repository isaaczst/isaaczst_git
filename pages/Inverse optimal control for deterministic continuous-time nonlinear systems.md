...
- There are generally two methods of approach within learning from demonstration. One approach is to learn a map from states to actions using classification or regression.
